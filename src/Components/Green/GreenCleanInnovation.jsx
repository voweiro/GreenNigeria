...
const GreenCleanInnovation = () => {
  return (
    <div className="bg-[#F6F6EE] py-16 flex items-center justify-center w-full">
      <div className="w-[90%] mx-auto flex flex-col lg:flex-row lg:items-center gap-10 lg:ml-[150px] overflow-visible">
        {/* Text Section */}
          ...
          <ul className="space-y-4">
            {[
              ...
              >
                ...
                {/* Text */}
                <p className="md:text-base font-albert font-[500] text-[18px] leading-10">
                  {item}
                </p>
              </li>
            ))}
        ...
        {/* Image Section */}
        <div className="relative flex justify-center lg:w-[45%] overflow-visible">
